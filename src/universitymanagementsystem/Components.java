...
// Creating the component  class for other labels and buttons
public class Components extends Frame {
    ...
    Components()
    {
        ...
        l1 = new JLabel("University Admission");
        ...
        rb3 = new JRadioButton("morning");
        rb3.setBounds(550, 200, 100, 30);
  
        rb4 = new JRadioButton("evening");
        ...
        String languages[]
            = { "pharm-d", "software engineering", "Computer science",
                "Visiual studies", "Media Science" };
        final JComboBox cb
        ...
        li1.addElement("pharm-d(2, 50, 000)");
        li1.addElement("BS SE(2, 50, 000)");
        li1.addElement("BS CS(2, 50, 000)");
        li1.addElement("BS VS(2, 50, 000)");
        li1.addElement("Media(2, 50, 000)");
        ...
        Receipt.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e)
            {
                ...
                if (rb1.isSelected()) {
                    area2.setText(area2.getText()
                                  + "Wants to Join in "
                                  + "Jinnah University for Sciences\n ");
                           
                }
                if (rb2.isSelected()) {
                    area2.setText(area2.getText()
                                  + "Wants to Join in "
                                  + "Jinnah university for Arts\n ");
